 ...
 *
 * `issues` is the issue list a 400 carries beside its prose message, so a
 * caller can map a rejected field back to the flag its user typed. Undefined
 * otherwise, and for an older server.
 */
