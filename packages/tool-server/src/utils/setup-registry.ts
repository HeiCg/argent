...
import { uninstallAppTool } from "../tools/uninstall-app";
import { settingsPermissionsTool } from "../tools/settings-permissions";
import { setLocationTool } from "../tools/set-location";
import { enableThirdPartyInstallTool } from "../tools/enable-third-party-install";
import { openUrlTool } from "../tools/open-url";
import { createScreenshotTool } from "../tools/screenshot";
import { createGestureTapTool } from "../tools/gesture-tap";
import { createGestureSwipeTool } from "../tools/gesture-swipe";
...
export function createRegistry(): Registry {
  ...
  registry.registerTool(uninstallAppTool);
  registry.registerTool(settingsPermissionsTool);
  registry.registerTool(setLocationTool);
  registry.registerTool(enableThirdPartyInstallTool);
  ...
  registry.registerTool(createGestureTapTool(registry));
