...
A not-connected or not-running app comes back as one of those statuses rather than a failure. The one failure this tool produces is the outright rejection of an Apple system app, which is terminal — never retry it.`,
  zodSchema,
  services: (params) => ({
