...
// should_restart instead of throwing, and HarmonyOS hints a dump that listed no
// windows), or when the selector matched on an earlier poll and the tree has
// since gone blank mid-navigation.
