 ...
 * HarmonyOS, whose `screenshot` route (`uitest screenCap`) has no counterpart
 * here because the flow engine has no harmony arm at all: the service resolved
 * below refuses the platform outright.
 *
