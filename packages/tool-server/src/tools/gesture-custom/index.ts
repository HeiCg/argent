...
// Physical iPhones are in, both halves: the CoreDevice touchscreen takes the
// Down/Move/Up stream directly, and tracks a second contact addressed by the
// contact-id byte of its report, so `x2`/`y2` work there too.
