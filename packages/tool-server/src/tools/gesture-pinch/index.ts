...
// Physical iPhones included: the CoreDevice touchscreen tracks two contacts,
// addressed by the contact-id byte of its report, and a two-finger pinch driven
// through it zooms a real app in and out.
