...
Allowed tools and their args (udid is auto-injected, do NOT include it in args):
  ...
  keyboard:       { text?: string, key?: string, delayMs?: number }  (key pressed after text; TV: text only; harmony: enter/return, backspace/delete, space, arrow-left, arrow-right only)  [ios/android/chromium/vega/tv/harmony]
