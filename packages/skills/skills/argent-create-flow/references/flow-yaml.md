...
| -------- | --------------------------------------------------------- | ------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| iOS      | projected UIView hierarchy                                | accessibility tree              | Each contains elements the other lacks; roles are derived differently. `native-full-hierarchy` shows the RAW view tree, which keeps views the runner drops |
