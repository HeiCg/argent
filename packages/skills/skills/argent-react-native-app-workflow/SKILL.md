...
| --------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **JavaScript errors / logs**      | Use `debugger-log-registry` to get a summary and log file path, then `Grep`/`Read` to search. If it returns `status: "not_connected"`, no log file of its own is returned — follow its `guidance` to reconnect first, and read its `note`: after a crash the note says what became of the dead session's console history, and names the log file when it left one — readable even from this state. |
