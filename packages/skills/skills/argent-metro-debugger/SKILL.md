...
| Tool                    | Purpose                                                                                                                                                                  |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `debugger-reload-metro` | Reload all connected apps on iOS / Apple TV / Android (like pressing "r" in Metro terminal). Needs a CDP target.                                                         |
| `restart-app`           | Terminate and relaunch the app by device id and bundleId (iOS / Apple TV / Android / Vega). Use when app lost Metro connection. On Chromium see the Quick Reference row. |

### Inspection & console

| Tool                       | Purpose                                                                                                                                                                                                              |
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `debugger-component-tree`  | Full React fiber tree on iOS / Apple TV / Android (names, depth, bounding rects, tap coordinates).                                                                                                                   |
| `debugger-inspect-element` | Inspect at (x, y) on iOS / Apple TV / Android using **logical pixel coordinates** (not normalized 0-1): component hierarchy with source file:line and code fragment. See `references/source-maps.md`.                |
...
| Reload JS (already connected)     | `debugger-reload-metro` (iOS / Apple TV / Android)                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Relaunch app on device            | `restart-app` (iOS / Apple TV / Android / Vega); not supported on Chromium, where `boot-device` only starts an app and never stops one — ask the user to quit it, then relaunch once it has exited — `boot-device` with `electronAppPath` for Electron, or ask the user to start the browser again on the same CDP port with `--remote-debugging-port` — then re-read the `chromium-cdp-<port>` id from `boot-device` / `list-devices`, since a relaunch on a new port is a new id |
| Inspect component at point        | `debugger-inspect-element` (iOS / Apple TV / Android)                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Full component tree               | `debugger-component-tree` (iOS / Apple TV / Android)                                                                                                                                                                                                                                                                                                                                                                                                                               |
