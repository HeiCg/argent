export const FAILURE_CODES = {
  ...
  ANDROID_SET_LOCATION_FAILED: "ANDROID_SET_LOCATION_FAILED",
  ANDROID_UNINSTALL_APP_FAILED: "ANDROID_UNINSTALL_APP_FAILED",
  ANDROID_ENABLE_THIRD_PARTY_INSTALL_FAILED: "ANDROID_ENABLE_THIRD_PARTY_INSTALL_FAILED",
  ...
  IOS_SET_LOCATION_FAILED: "IOS_SET_LOCATION_FAILED",
  IOS_UNINSTALL_APP_FAILED: "IOS_UNINSTALL_APP_FAILED",
  ...
  OPEN_DEVICE_SERVER_ADB_NOT_FOUND: "OPEN_DEVICE_SERVER_ADB_NOT_FOUND",
  OPEN_DEVICE_SERVER_ADB_FORWARD_UNEXPECTED: "OPEN_DEVICE_SERVER_ADB_FORWARD_UNEXPECTED",
  OPEN_DEVICE_SERVER_EXITED_BEFORE_READY: "OPEN_DEVICE_SERVER_EXITED_BEFORE_READY",
  OPEN_DEVICE_SERVER_PROCESS_ERROR: "OPEN_DEVICE_SERVER_PROCESS_ERROR",
  OPEN_DEVICE_SERVER_READY_TIMEOUT: "OPEN_DEVICE_SERVER_READY_TIMEOUT",
  OPEN_DEVICE_SERVER_FACTORY_OPTIONS_MISSING: "OPEN_DEVICE_SERVER_FACTORY_OPTIONS_MISSING",
  OPEN_DEVICE_SERVER_WRONG_PLATFORM: "OPEN_DEVICE_SERVER_WRONG_PLATFORM",
  OPEN_DEVICE_SERVER_DEVICE_ID_INVALID: "OPEN_DEVICE_SERVER_DEVICE_ID_INVALID",
  OPEN_DEVICE_SERVER_TERMINATED: "OPEN_DEVICE_SERVER_TERMINATED",
  OPEN_DEVICE_SERVER_RPC_CLIENT_CLOSED: "OPEN_DEVICE_SERVER_RPC_CLIENT_CLOSED",
  OPEN_DEVICE_SERVER_RPC_ERROR: "OPEN_DEVICE_SERVER_RPC_ERROR",
  OPEN_DEVICE_SERVER_RPC_TIMEOUT: "OPEN_DEVICE_SERVER_RPC_TIMEOUT",
  OPEN_DEVICE_SERVER_SOCKET_CLOSED: "OPEN_DEVICE_SERVER_SOCKET_CLOSED",
