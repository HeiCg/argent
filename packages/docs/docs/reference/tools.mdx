...
| `uninstall-app`              | Uninstall an app, removing its data and runtime permissions                                   |
...
| `set-location`               | Set the simulated GPS location on a simulator or emulator                                     |
| `enable-third-party-install` | Allow an Android app to install other APKs (REQUEST_INSTALL_PACKAGES)                         |
