...
| `scripts.maxTimeoutMs`     | global          | global wins      | The largest time limit, in milliseconds, that a flow `script` step can ask for. Default `300000` (five minutes)                       |
...
| global wins      | The global value wins. Thus a project file cannot raise a script limit        |
