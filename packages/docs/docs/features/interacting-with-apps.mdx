...
The agent also sets device-wide settings without opening the Settings app: dark mode, text size, reduce motion, airplane mode or Wi-Fi. This makes visual tests repeatable, because each run starts from a known theme and text size.
