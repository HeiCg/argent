...
- **Agent-E** — Abuelsaad, Sadhukhan, Kokku et al., arXiv:2407.13032 (2024).
  ...
  and _change observation_: each action skill reports the resulting DOM change
...
- **Executable Agentic Memory for GUI Agents** — arXiv:2605.12294 (2026).
  ...
  actions, transitions) built by _offline DFS exploration_, MCTS path
...
- **AppAgentX** — Westlake AGI Lab, arXiv:2503.02268 (2025).
  https://arxiv.org/abs/2503.02268. Chain memory built _online_ from task
...
- **Read More, Think More** — arXiv:2604.01535 (2026).
  https://arxiv.org/html/2604.01535. Strong models do _better_ with richer
...
https://dl.acm.org/doi/10.1145/3551349.3559505 — _reuses the transition model
across runs_, deployed at ByteDance). Differs: graphs serve random explorers
...
- Industry (acknowledge, not peer-reviewed): Playwright ARIA snapshots with
  ...
  Stagehand caches _action plans_ by DOM hash
