...
- **34895279791** (run 1) — FAIL _Install deps_: `npm ci` rejected the new
  `@argent/ios-device-server` workspace (`Missing: @argent/ios-device-server@0.22.1
from lock file`). Fix: CI uses `npm install`.
- **34896291506** (run 2) — FAIL _Create/boot simulator_: the device-type picker
...
- **34899964412** (extra 2) — FAIL _Build the workspace TypeScript_:
